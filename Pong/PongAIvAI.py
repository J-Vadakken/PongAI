...
def init_game():
    ...
    #import V1_chaser_ai
    import V2_angles_ai
    import V4_offence_ai
    
    paddles[0].move_getter = V4_offence_ai.pong_ai
    #paddles[1].move_getter = directions_from_input #chaser_ai.pong_ai
    #paddles[1].move_getter = V1_chaser_ai.pong_ai #V1_chaster_ai.pong_ai
    paddles[1].move_getter = V2_angles_ai.pong_ai #V2_angles_ai.pong_ai
